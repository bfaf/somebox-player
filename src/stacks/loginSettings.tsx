...
import { resetUpdateState, selectIsSettingsUpdated, selectServerIpAddress, selectSettingsError } from '../redux/slices/settingsSlice';
        ...
        <SafeAreaView>
            ...
            {settingsError != null && (
                <View style={{ alignItems: 'center'}}>
                    <Text style={styles.infoText}>Error occured while updating the settings</Text>
                    <Text style={styles.infoText}>Check whether you have enough free space on your device</Text>
